...
async def on_ready():
    ...
    print(bot.user.id)
    print('--------')
    await bot.change_presence(game=discord.Game(name='2 SERVES',type=0))
    await bot.change_presence(game=discord.Game(name='anime',type=0))
    await bot.change_presence(game=discord.Game(name='LOOKING FOR UPDATES!!',type=0))
...
@bot.command()
async def wtf():
    await bot.say('__**NO BAD WORDS OR YOU WILL BE KICKED/BANNED**__')
...
bot.run('NTU2ODMxNDA4OTkyMTU3NzE1.D2_mgQ.cG8qd535RfJOF9qNQj8bbOLAsf8')
